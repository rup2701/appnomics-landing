  ...
  return (
    <section className="py-24 border-t border-[#1a1a1a] bg-[#0d0d0d]">
      <div className="max-w-[900px] mx-auto px-10">
        ...
        <a
          href="/#portfolio"
          className="inline-flex items-center gap-2 text-[11px] text-[#444] font-mono hover:text-[#666] transition-colors no-underline mb-12"
        >
          ← Back to Portfolio
        </a>
        ...
        <div className="mb-16">
          ...
          <p className="text-lg text-[#777] font-mono leading-[1.7] max-w-[700px]">
            AI-powered sports prediction platform with subscription tiers, live feed ingestion, and a picks leaderboard.
          </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-16">
          <div>
            ...
            <div className="space-y-4">
              <p className="text-[13px] text-[#777] font-mono leading-[1.8]">
              ...
              <ul className="space-y-2">
                {[
                  ...
                  <li key={point} className="flex items-start gap-2 text-[12px] text-[#666] font-mono leading-[1.6]">
