    ...
    <>
      ...
      <section className="py-24 border-t border-[#1a1a1a] bg-[#0d0d0d]">
        <div className="max-w-[1340px] mx-auto px-10">
          ...
          <Link
            href="/#portfolio"
            className="inline-flex items-center gap-2 text-[12px] text-[#888] font-sans hover:text-[#666] transition-colors no-underline mb-12"
          >
            ← Back to Portfolio
          </Link>
          ...
          <div className="mb-16">
            <div className="flex items-center gap-3 mb-4">
              <span className="text-[10px] text-[#00d4ff] font-sans tracking-[0.15em] bg-[#00d4ff0d] border border-[#00d4ff33] px-3 py-1 rounded-[2px]">
                CASE STUDY
              </span>
              <span className="text-[10px] text-[#444] font-sans">/</span>
              <span className="text-[10px] text-[#666] font-sans">SPORTS / ANALYTICS</span>
            </div>

            <h1 className="text-[clamp(32px,4vw,48px)] font-bold text-[#e0e0e0] leading-[1.1] font-sans mb-4">
              GunnerWins
            </h1>
            <p className="text-lg text-[#777] font-sans leading-[1.7] max-w-[700px]">
            ...
            <div className="flex flex-wrap items-center gap-4 mt-6">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="text-[13px] text-[#00d4ff] font-sans border-b border-[#00d4ff33] hover:border-[#00d4ff] transition-colors no-underline"
              >
                gunnerpicks.com ↗
              </a>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-16">
            <div>
              <h3 className="text-lg font-bold text-[#fff9] uppercase tracking-[0.15em] font-sans mb-4">
                The Challenge
              </h3>
              <div className="space-y-4">
                <p className="text-MD text-[#888] font-sans leading-[1.8]">
                ...
                <ul className="space-y-2">
                  {[
                    ...
                    <li key={point} className="flex items-start gap-2 text-md text-[#999] font-sans leading-[1.6]">
          ...
          {/* Tech Stack */}
          <div className="mb-16">
            <h3 className="text-[11px] font-bold text-[#444] uppercase tracking-[0.15em] font-sans mb-4">
              Tech Stack
            </h3>
          ...
          <div className="border-l-2 border-[#00d4ff] pl-6 py-2 mb-16 bg-[#00d4ff08] rounded-r-[2px] p-6">
            <p className="text-[13px] text-[#888] font-sans leading-[1.8] italic">
            ...
            <p className="text-[11px] text-[#444] font-sans mt-4">— Gunner Picks</p>
          </div>
          ...
          <div className="border border-[#1f1f1f] rounded-[2px] p-8 text-center bg-[#0d0d0d]">
            ...
            <p className="text-[12px] text-[#666] font-sans mb-6">
              Let's scope your project in 24 hours.
            </p>
            <a
              href="/#intake"
              className="inline-block px-8 py-3 border border-[#00ff9d] rounded-[2px] text-[12px] font-bold text-[#00ff9d] font-sans no-underline hover:bg-[#00ff9d] hover:text-[#0a0a0a] transition-all duration-200"
            >
              START BUILDING →
            </a>
          </div>
